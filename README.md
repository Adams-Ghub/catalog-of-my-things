...
# 📗 Table of Contents
p
- [Catelogue of my Things](#about-project)
...
```sh
  cd my-folder
  git git@github.com:Adams-Ghub/catalog-of-my-things.git
```
...
Feel free to check the [issues page](https://github.com/Adams-Ghub/catalog-of-my-things/issues).
